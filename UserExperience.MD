...
## 🔍 4. Review Sessions (The Drill-Down)
...
3.  **Real-time Math**: SPR and MDF are calculated on-the-fly when viewing a specific hand to save database space, or retrieved from the pre-calculated `Actions` table.