...
│       │   └── stats.py          # vpip_pct, pfr_pct, win_rate_bb100, aggression_factor, wtsd_pct, total_profit
...
│       │   └── pages/
│       │       ├── __init__.py
│       │       ├── home.py       # "/" — navigation hub with links to Upload, Sessions, Dashboard, Settings
...
│   ├── test_frontend.py          # 47 tests for upload handler, multi-page app, page layouts, cards, dashboard, settings
│   └── test_analysis.py          # 37 tests for queries and stats (vpip, pfr, win_rate, AF, wtsd, timeline)
├── data/
