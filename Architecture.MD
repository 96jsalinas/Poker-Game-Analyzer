...
│   ├── test_frontend.py          # 152 tests: upload handler, multi-page app, page layouts, action view math, dashboard, filters (incl. game type toggle), guide, showdown, favourites, DataTable, format helpers
