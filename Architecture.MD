...
│       │   │                     # get_hero_timeline, get_hero_actions → DataFrames
...
│       │   └── pages/
│       │       ├── __init__.py
│       │       ├── home.py       # "/" — navigation hub with links to Upload, Sessions, Dashboard
...
│   ├── test_frontend.py          # 42 tests for upload handler, multi-page app, page layouts, cards, dashboard
