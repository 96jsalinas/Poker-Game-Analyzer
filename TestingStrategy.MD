...
* **Current test count (653 total):**

| File | Tests | Scope |
| :--- | :--- | :--- |
| `test_parser.py` | 164 | 15 classes — parser rules, SPR/MDF, re-buy, multi-street, EUR currency format, currency detection (USD/EUR/PLAY) |
